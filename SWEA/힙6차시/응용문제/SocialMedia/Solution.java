...
//                System.out.println(Arrays.toString(ans_pIdList));
...
//                System.out.println(Arrays.toString(pIdList));
                ...
                for (int i = 0; i < 10; i++)
                {
                    ...
                    //System.out.println("답:" + ans_pIdList[i] + "  / 내꺼:"+pIdList[i]);
    ...
    public static void main(String[] args) throws Exception {
        System.setIn(new java.io.FileInputStream("src/SWExpertAcademyProblem/힙6차시/res/input8.txt"));
